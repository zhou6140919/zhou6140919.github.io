...
{% include elements/button.html link="https://www.coursera.org/specializations/algorithms" text="Coursera" %}
...
For more details please see the repo and course videos from Coursera above.
